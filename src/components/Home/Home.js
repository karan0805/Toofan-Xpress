  ...
  return (
    <div className="wrapper">
      <div className="sidebar">
        <button
          className={`mybutton ${showBusiness ? "active" : ""}`}
          onClick={() => setShowBusiness((prevVal) => !prevVal)}
        >
          Business
        </button>
        <button
          className={`mybutton ${showSports ? "active" : ""}`}
          onClick={() => setShowSports((prevVal) => !prevVal)}
        >
          Sports
        </button>
        <button
          className={`mybutton ${showTechnology ? "active" : ""}`}
          onClick={() => setShowTechnology((prevVal) => !prevVal)}
        >
          Technology
        </button>
        <button
          className={`mybutton ${showScience ? "active" : ""}`}
          onClick={() => setShowScience((prevVal) => !prevVal)}
        >
          Science
        </button>
        <button
          className={`mybutton ${showHealth ? "active" : ""}`}
          onClick={() => setShowHealth((prevVal) => !prevVal)}
        >
          Health
        </button>
        <button
          className={`mybutton ${showEntertainment ? "active" : ""}`}
